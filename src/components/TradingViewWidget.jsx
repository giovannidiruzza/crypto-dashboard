      ...
      try {
        ...
        new window.TradingView.widget({
          ...
          studies_overrides: {
            ...
            'volume weighted average price.upper band #1.color': '#00f2fe',
            'volume weighted average price.lower band #1.color': '#00f2fe',
            'volume weighted average price.upper band #2.color': '#f59e0b',
            'volume weighted average price.lower band #2.color': '#f59e0b',
            'volume weighted average price.upper band #3.color': '#ec4899',
            'volume weighted average price.lower band #3.color': '#ec4899',
            ...
            'volume weighted average price.upper band #3.linewidth': 1,
            'volume weighted average price.lower band #3.linewidth': 1,
            'vwap.showBands': true,
